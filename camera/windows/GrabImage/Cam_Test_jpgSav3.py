...
def saveImage():
    ...
    #     cdll.msvcrt.memcpy(byref(img_buff), stConvertParam.pImageBuffer, stConvertParam.nImageLen)  # 获取图像数据
    #     rgb_data=np.array(data_buf)
