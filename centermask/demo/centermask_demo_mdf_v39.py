...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="../configs/centermask/centermask_V_39_eSE_FPN_lite_res600_ms_bs16_4x.yaml",
        metavar="FILE",
        help="path to config file",
    )
    parser.add_argument(
        "--weights",
        default="../tools/checkpoints/CenterMask-Lite-V-39-eSE-FPN-res600-ms-bs16-4x/model_0180000.pth",
        metavar="FILE",
    ...
    parser.add_argument(
        '--output_dir',
        default='demo/results/CenterMask-Lite-V-39-eSE-FPN',
    ...
    for i in range(num_images):
        ...
        if os.path.splitext(imglist[i])[1] in ['.mp4', '.wmv', '.avi']:
            ...
            cv2.imwrite(save_path, composite[0])
